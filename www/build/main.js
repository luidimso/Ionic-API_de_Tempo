...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_sqlite__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_toast__ = __webpack_require__(155);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, sqlite, toast) {
    ...
    LoginPage.prototype.criarBanco = function () {
        this.sqlite.create({
            ...
            db.executeSql('CREATE TABLE IF NOT EXISTS usuario(id INTEGER PRIMARY KEY, nome TEXT, cidade TEXT, senha TEXT)', []).then(function (res) { return console.log('Executed SQL'); }).catch(function (e) { return console.log(e); });
        }).catch(function (e) { return console.log(e); });
    };
    LoginPage.prototype.cadastrar = function (nome, cidade, senha) {
        this.sqlite.create({
            name: 'weather.db',
            location: 'default'
        }).then(function (db) {
            db.executeSql('INSERT INTO usuario VALUES(NULL,?,?,?)', [nome, cidade, senha]).then(function (res) {
                console.log(res);
            }).catch(function (e) {
                console.log(e);
            });
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/home/luidi/Desktop/Ionic-API_de_Tempo/src/pages/login/login.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>login</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label>Nome</ion-label>\n    <ion-input type="text" #nome></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Cidade</ion-label>\n    <ion-input type="text" #cidade></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Senha</ion-label>\n    <ion-input type="password" #senha></ion-input>\n  </ion-item>\n\n  <button ion-button (click)="cadastrar(nome.value, cidade.value, senha.value)">Cadastrar</button>\n</ion-content>\n'/*ion-inline-end:"/home/luidi/Desktop/Ionic-API_de_Tempo/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_sqlite__["a" /* SQLite */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_toast__["a" /* Toast */]])
    ], LoginPage);
    return LoginPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_sqlite__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_toast__ = __webpack_require__(155);
